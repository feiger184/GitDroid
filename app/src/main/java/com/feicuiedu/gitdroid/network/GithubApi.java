...
public interface GithubApi {
    ...
    // 进行开发应用注册得到的应用信息
    String CLIENT_ID = "9b6440d68630e6b00d3d";
    String CLIENT_SECRET = "d86fda4687ec499f35393adaf8c4b1b4fa36003c";
    String AUTH_SCOPE = "user,public_repo,repo";

    String CALL_BACK = "feicuigit";
    ...
    Call<RepoResult> searchRepos(@Query("q") String q, @Query("page") int page);
